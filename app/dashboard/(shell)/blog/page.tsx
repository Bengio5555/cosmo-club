              ...
              <tr key={a.id} className="text-slate-700 dark:text-slate-200">
                <td className="px-4 py-3">
                  ...
                  >
                    ...
                    <div className="mt-0.5 truncate text-[11px] text-slate-500 dark:text-slate-500">
                      /blog/{a.slug}
                    </div>
                  </Link>
                </td>
                ...
                <td className="px-4 py-3 hidden lg:table-cell text-xs text-slate-500 dark:text-slate-500">
