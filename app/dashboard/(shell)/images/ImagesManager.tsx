  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[200px_minmax(0,1fr)]">
      ...
      <aside className="space-y-2">
        ...
        {pages.length === 0 ? (
          <p className="text-xs text-neutral-500">Aucune page configurée.</p>
        ) : (
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <button
            ...
            disabled={pending}
            className="inline-flex items-center gap-1 rounded-md border border-neutral-800 bg-neutral-900 px-2.5 py-1 text-[11px] text-neutral-300 hover:border-neutral-700 hover:text-white disabled:opacity-50"
          >
        ...
        <div className="grid gap-4 lg:h-[calc(100vh-260px)] lg:grid-cols-[320px_minmax(0,1fr)]">
          ...
          <section className="flex min-h-0 flex-col overflow-hidden rounded-xl border border-neutral-800 bg-neutral-950/60">
          ...
          {/* Right: detail panel */}
          <section className="overflow-y-auto rounded-xl border border-neutral-800 bg-neutral-950/60">
      ...
      <div className="space-y-2">
        ...
        {editingTitle ? (
          ...
          <button
            ...
            className="w-full rounded-md border border-neutral-800 bg-neutral-900 px-3 py-2 text-left text-sm text-white transition-colors hover:border-neutral-700"
          >
