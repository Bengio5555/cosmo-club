        ...
        <>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-slate-100 dark:border-slate-900 pt-4">
            ...
            <button
              ...
              onClick={clear}
              disabled={pending}
              className="inline-flex items-center gap-1.5 rounded-md border border-red-300 dark:border-red-500/30 bg-red-50 dark:bg-red-500/5 px-3 py-2 text-xs text-red-700 dark:text-red-300 transition-colors hover:bg-red-100 dark:hover:bg-red-500/10 disabled:opacity-50"
            >
