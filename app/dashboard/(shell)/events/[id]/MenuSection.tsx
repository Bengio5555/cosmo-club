    ...
    <section className="rounded-xl border border-neutral-800 bg-neutral-950/60 p-4 md:p-5">
      ...
      {showCompute && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
          <div className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-xl border border-neutral-800 bg-neutral-950 p-5 shadow-2xl">
            ...
            {computed.length === 0 ? (
              ...
              <table className="w-full text-left text-sm">
                  ...
                  {computed.map((l) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td
                          className={`px-2 py-2 text-right ${short ? "text-red-300 font-medium" : "text-neutral-400"}`}
                        >
                          {l.stockQty}
                          {short && (
                ...
                <tfoot>
                  <tr className="border-t-2 border-neutral-800 text-[11px]">
