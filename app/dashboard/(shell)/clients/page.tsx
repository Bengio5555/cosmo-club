  ...
  return (
    <div className="px-4 py-6 md:px-8 md:py-8">
      ...
      >
        ...
        <button
          type="submit"
          className="rounded-md border border-neutral-800 bg-neutral-900 px-3 py-1 text-xs font-semibold text-neutral-100 hover:border-neutral-700"
        >
          Filtrer
        </button>
      </form>
      ...
      <div className="overflow-hidden rounded-xl border border-neutral-800 bg-neutral-950/60">
        {sortedClients.length > 0 ? (
                  ...
                  >
                    <td className="px-3 py-3 md:px-4">
                      ...
                      >
                        {displayName}
                        {isB2B && (
                          <span className="rounded-full border border-neutral-700 bg-neutral-900 px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-wide text-neutral-400">
                            B2B
                          </span>
                        )}
                      </Link>
                      ...
                      <p className="text-[11px] text-neutral-500 md:hidden">
                        {c.email ?? c.phone ?? "—"}
                      </p>
                    </td>
                    ...
                    <td className="px-3 py-3 text-right text-neutral-300 md:px-4">
                      {nbQuotes || <span className="text-neutral-600">—</span>}
                    </td>
                    <td className="px-3 py-3 text-right text-neutral-300 md:px-4">
                      {nbInvoices || <span className="text-neutral-600">—</span>}
                    </td>
                    <td className="px-3 py-3 text-right font-medium text-neutral-100 md:px-4">
                      {ca > 0 ? formatEUR(ca) : <span className="text-neutral-600">—</span>}
                    </td>
                  </tr>
                );
              })}
          ...
          <div className="p-8 text-center text-sm text-neutral-500">
            Aucun client ne correspond à <span className="text-neutral-300">“{query}”</span>.
          </div>
        ) : (
