...
export default function RootLayout({
  ...
  return (
    <html lang="fr" className={fontClassName} suppressHydrationWarning>
      <head>
        {/* No-flash dashboard bootstrap. Runs in <head> before any
            paint: on /dashboard routes it paints the dark canvas on
            <html> immediately, so a reload never flashes the cream body
            before the (dark-only) dashboard chrome mounts. No-op on the
            public site, which stays cream. */}
        <script
