...
const config: LandingConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Oui, nous nous déplaçons dans tout Paris intra-muros et dans toute l'Île-de-France (Yvelines, Hauts-de-Seine, Seine-Saint-Denis, Val-de-Marne, Essonne, Val-d'Oise, Seine-et-Marne). Les frais de déplacement à Paris intra-muros sont inclus dans la prestation. Pour les départements limitrophes, un défraiement raisonnable est ajouté au devis selon la distance — comptez en moyenne 80 à 150 € selon que le lieu est à 30 minutes ou à 1h30 de route. Pour les destinations hors région — par exemple un mariage dans un château en Bourgogne, en Provence, en Normandie ou en Bretagne — nous étudions chaque projet au cas par cas en fonction de la logistique de votre lieu : accessibilité camion pour l'installation, présence d'un point d'eau et d'électricité, possibilité d'héberger l'équipe la veille si la prestation commence avant midi. Nous avons l'habitude des mariages destination en France et travaillons régulièrement avec des wedding planners qui gèrent ce type d'événement hors zone urbaine, en moyenne sur 6 à 10 mariages destination par saison.",
    },
    {
      q: "Personnalisez-vous le bar aux couleurs du mariage ?",
      a: "Oui, la personnalisation visuelle du bar fait partie intégrante de notre approche. Six leviers de personnalisation sont disponibles : sticker pleine façade reprenant votre monogramme ou direction artistique (1m20 à 3m de façade selon le bar choisi), glaçons gravés au logo ou aux initiales (logo, fleur comestible, feuille d'or 24 carats), pastilles comestibles flottant à la surface du cocktail avec votre motif imprimé en couleur, toppings fruits sculptés aux initiales du couple, pochoirs sur la mousse des lattes ou des cappuccinos baristas, néon sur mesure pour la scénographie d'ambiance (« M & A », date du mariage, mot choisi). La composition florale du bar et l'impression des cartes cocktails sont offertes — elles font partie du service de base, déclinables sur trois formats de papier. Les éléments plus complexes (néon dimensionné, scénographie sur-mesure complète, mobilier custom) sont chiffrés au devis selon votre vision. L'objectif : que le bar lise comme une extension de votre direction artistique, pas comme un meuble générique posé dans le décor.",
    },
    {
